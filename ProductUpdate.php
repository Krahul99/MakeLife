...
if (isset($_POST["submit"])) {
  ...
  $sql = "UPDATE `product` SET `ProductName`='$ProductName',`ProductPrice`='$ProductPrice',`Productdescription`='$Productdescription' WHERE `ProductID`='$ProductID'";


  $result = mysqli_query($conn, $sql);
  if ($result) {
    echo '<script type="text/javascript">';
    echo ' alert("Product Updated to Database")';
    echo '</script>';
  } else {
    echo '<script type="text/javascript">';
...
<head>
  <title> Product Updating Page</title>
...
<body>
  ...
  <div class="topnav">
    ...
    <a href="ProductUpdate.php" class="active">Product Update</a>
  ...
  <div class="container-fluid" style="background-color:#19E46C;">
    <div class="row">
      ...
      <div class="col-md-10">
        <br>
        <b>
          <h4 class="b">Product <span class="a"> Updations </span></h4>
        </b>
        ...
        <div class="container card card-body" style="background-color:#19E46C;border-radius:10px;border: 0px;">
          <div class="row">
            <div class="col-md-6">
              <form action="ProductUpdate.php" method="POST" class="text-center container" enctype="multipart/form-data" style="border-radius:50%;">
  ...
  <hr style="border:20px solid #E798AE">
